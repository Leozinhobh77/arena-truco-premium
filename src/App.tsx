...
const Sala2v2_1Overlay = lazy(() => import('./overlays/Sala2v2_1Overlay').then(m => ({ default: m.Sala2v2_1Overlay })));
      ...
      <div className="app-shell">
        ...
        <Suspense fallback={null}>
          <AnimatePresence>
            ...
            {activeOverlay === 'sala-2v2-1' && <Sala2v2_1Overlay key="sala-2v2-1" />}
